...
if (amysBirthYear === brittanisBirthYear){
  ...
  console.log("Amy and Brittani were not born i the same year.")
};
...
// If (nums[i] % 2) != 0, you would be able to push odd numbers instead
...
if (myFavoriteNumbers = [4,8,12,16,20,24]){
...
// backticks allow for both multiline strings and string interpolation (which we saw above)
// Template literals are enclosed by the backtick (` `) (grave accent) character instead of double or single quotes.
// Template literals can contain placeholders. These are indicated by the dollar sign and curly braces ie (${expression}). The expressions in the placeholders and the text between the backticks (` `) get passed to a function.
